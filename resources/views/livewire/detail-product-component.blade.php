                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 0 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                <div>
                                    <del><span class="regprice">{{ currency_IDR($product->regular_price) }}</span></del>
                                </div>
                                <div class="pt-3">
                                    <span class="product-price">{{ currency_IDR($product->sale_price) }}</span>
                                </div>
                            </div>
                        @else
                            <div class="wrap-price"><span class="product-price">{{ currency_IDR($product->regular_price) }}</span></div>
                        @endif
                            ...
                            @foreach ($related_product as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{ currency_IDR($r_product->regular_price) }}</span></div>
                                    </div>
                                </div>
                            @endforeach
